...
import MainButton from '@/components/ui/MainButton'; // Обновленный путь для согласованности
...
/**
 * Компонент, демонстрирующий ключевые преимущества CASHBATE.
 */
            ...
            <div className=" max-w-7xl mx-auto">
                <div className=" rounded-3xl px-4 py-8 sm:py-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        {/* Левая колонка: Текстовый контент. На мобильных устройствах будет первой. */}
                        <div className="flex flex-col space-y-8">
                            ...
                            {/* Кнопка действия */}
                            <div className="pt-4">
                                <MainButton text="Learn Why Sellers Choose Us" link="#get-started" />
                            </div>
                        </div>

                        {/* Правая колонка: Изображение. Классы order удалены для естественного порядка. */}
