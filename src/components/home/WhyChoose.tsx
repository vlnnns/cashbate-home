...
// Интерфейс для пропсов FeatureCard
...
const FeatureCard = ({ icon, title, description }: FeatureCardProps) => (
    <div className="bg-white px-6 sm:px-8 py-16 rounded-3xl flex flex-col items-start justify-between h-full">
        {/* Icon Container */}
...
const WhyChooseCashbateSection = () => {
    ...
    return (
        <section className="py-20 antialiased max-w-7xl mx-auto px-4">
            <div className="">
                {/* Section Title */}
                <h2 className="text-4xl sm:text-5xl font-semibold text-gray-900 mb-12 lg:mb-16 leading-tight">
